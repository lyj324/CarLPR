 ...
 * 确定车牌位置,初步筛选出可能是“车牌”的矩形。使其大小为136*36便于进一步处理
 */
public class PlateLocate {
    /**
     * 是否开启生活模式识别复杂场景，还是使用默认参数
     *
     * @param islifemode
     */
     ...
     */
    public Vector<opencv_core.Mat> plateLocate(opencv_core.Mat src) {
        Vector<opencv_core.Mat> resultVec = new Vector<opencv_core.Mat>();
