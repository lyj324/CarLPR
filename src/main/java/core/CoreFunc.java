...
public class CoreFunc {
     ...
     */
    public static opencv_core.Mat colorMatch(final opencv_core.Mat src, final Color r, final boolean adaptive_minsv) {
        ...
        opencv_core.Mat src_grey = hsvSplit_done.get(2);
     ...
     * @return
     */
    public static boolean plateColorJudge(final opencv_core.Mat src, final Color color, final boolean adaptive_minsv) {
        // 判断阈值
        final float thresh = 0.49f;

        opencv_core.Mat gray = colorMatch(src, color, adaptive_minsv);
