...
public class CharsIdentify {
     ...
     * @return
     */
    public String charsIdentify(final opencv_core.Mat input, final Boolean isChinese, final Boolean isSpeci) {
        String result = "";

        opencv_core.Mat f = features(input, this.predictSize);
    ...
    private int classify(final opencv_core.Mat f, final Boolean isChinses, final Boolean isSpeci) {
        int result = -1;
        opencv_core.Mat output = new opencv_core.Mat(1, numAll, CV_32FC1);
